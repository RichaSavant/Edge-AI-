...
public class preg_health_dup {
	static List<FogDevice> fogDevices = new ArrayList<FogDevice>();
	static List<Sensor> sensors = new ArrayList<Sensor>();
	static List<Actuator> actuators = new ArrayList<Actuator>();
	static int numOfAreas = 2 ;//fog nodes
	
	static int numOfECGPerArea=2;
	static int numOfThermoPerArea=2;
	static int numOfSphygmoPerArea=2;
	...
	public static void main(String[] args) {
		...
		try {
			...
			for(FogDevice device : fogDevices){
				if(device.getName().startsWith("c")){ // names of all Smart ecgs start with 'm' 
	...
	private static FogDevice addECG(String id, int userId, String appId, int parentId){
		FogDevice ecg = createFogDevice("c-"+id, 100, 512, 10000, 5000, 3, 0, 0.1, 0.5);
	...
	private static FogDevice addSphygmo(String id, int userId, String appId, int parentId){
		FogDevice bp = createFogDevice("b-"+id, 50, 256, 5000, 2000, 3, 0.1, 0.5, 0.2);
	...
	private static FogDevice addThermo(String id, int userId, String appId, int parentId){
		FogDevice th = createFogDevice("t-"+id, 25, 128, 1000, 1000, 3, 0.1, 0.2, 0.1);
